...
#
asim -cc -cc_dest $DSN/coverage/task_2_cc_tb1 -cc_hierarchy -cc_all task_2_cfg_tb1
...
run -all
endsim
write wave "D:\Programming\VHDL\finite-state-machines\source\finite_state_machines\src\task_2_TB\task_2_tb1.awf"
#close -wave
