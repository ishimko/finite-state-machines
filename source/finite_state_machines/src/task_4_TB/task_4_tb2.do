#  File: 'd:\Programming\VHDL\finite-state-machines\source\finite_state_machines\src\task_4_TB\task_4_tb2.do'
...
comp "d:\Programming\VHDL\finite-state-machines\source\finite_state_machines\src\task_4_TB\task_4_tb2.vhd"

#
# set top-level and initialize the simulator with Code Coverage Data
#
asim -cc -cc_dest $DSN/coverage/task_4_cc_tb2 -cc_hierarchy -cc_all task_4_cfg_tb2
...
run -all
endsim
write wave "d:\Programming\VHDL\finite-state-machines\source\finite_state_machines\src\task_4_TB\task_4_tb2.awf"
#close -wave
